...
<div class="card mb-3">
    <div class="card-body d-flex gap-4">
        ...
        <form action="{{ route('checkout.product', ['id' => $x->id]) }}" method="POST" class="delete-form">
            ...
            <div class="desc w-100">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-5 d-flex">
                        ...
                        <input type="number" name="qty" class="form-control w-25 text-center qty" id="qty" name="qty"
                            value="{{ $x->qty }}">
...
<!-- Script untuk meng-handle penghapusan tanpa konfirmasi -->
<script>
$(document).ready(function() {
    // Meng-handle klik tombol delete
    $('.btn-danger').on('click', function(e) {
        e.preventDefault(); // Mencegah aksi bawaan tombol

        // Mendapatkan form yang berada di atas tombol delete
        ...
        $.ajax({
            ...
            data: form.serialize(),
            success: function() {
                // Refresh halaman atau lakukan sesuatu setelah penghapusan
                location.reload();
            },
            error: function() {
