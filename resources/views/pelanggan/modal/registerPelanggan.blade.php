        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="name" id="nama" value="" placeholder="Your name"
                            required>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    <label for="alamat" class="col-sm-3 col-form-label">Alamat 1 <span
                            style="color:red;">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Input Address 1"
                            required>
                    </div>
                </div>
                <div class="mb-3 row">
